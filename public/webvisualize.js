...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'web/webvisualize.data';
    var REMOTE_PACKAGE_BASE = 'webvisualize.data';
...
Module['FS_createPath']('/', 'data', true, true);
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_web/webvisualize.data');

    };
    Module['addRunDependency']('datafile_web/webvisualize.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 52764, "filename": "/data/xkcd-script.ttf"}], "remote_package_size": 52764, "package_uuid": "470760b2-a634-40ff-8a02-2535ffa0009a"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5300464,
    DYNAMIC_BASE = 5300464,
    DYNAMICTOP_PTR = 57328;
...
var wasmBinaryFile = 'webvisualize.wasm';
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=57376;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
